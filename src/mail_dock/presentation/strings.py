...
WIZARD_BUTTON_STORAGE_TEST = "ストレージ適合性を確認"
...
WIZARD_ENCRYPTION_DECLARATION_HELP = "暗号化状態は自動検出せず、ユーザーの申告として記録します。"
...
WIZARD_STATUS_STORAGE_TEST_REQUIRED = "次へ進む前にストレージ適合性を確認してください。"
...
TOOLTIP_UNREAD = "未読 (確認日時: {seen_at})"
TOOLTIP_UNREAD_UNKNOWN = "未読 (同期時点のスナップショット)"
TOOLTIP_IMAP_FLAGS = "スター付き (確認日時: {seen_at})"
TOOLTIP_IMAP_FLAGS_UNKNOWN = "スター付き (同期時点のスナップショット)"
...
SETTINGS_LABEL_STORAGE_CAPABILITY = "ストレージ適合性"
SETTINGS_LABEL_CREDENTIAL_STORAGE = "資格情報の保存方式"
SETTINGS_LABEL_KEYRING_BACKEND = "keyringバックエンド"
SETTINGS_BUTTON_REPROBE_STORAGE = "再検査"
SETTINGS_STATUS_REPROBING_STORAGE = "ストレージを再検査しています..."
SETTINGS_STATUS_REPROBE_COMPLETE = "ストレージを再検査しました。"
SETTINGS_STATUS_REPROBE_UNAVAILABLE = "ストレージの再検査を実行できません。"
...
STATUS_STORAGE_CAPABILITY_DEGRADED = "ストレージ適合性: DEGRADED (制限あり)"
STATUS_STORAGE_CAPABILITY_UNSUPPORTED = "ストレージ適合性: UNSUPPORTED (続行中・警告)"
STATUS_STORAGE_ENCRYPTION = "暗号化: {state} (申告)"
STATUS_CREDENTIAL_STORAGE_SESSION_ONLY = "資格情報: session_only (このプロセスのメモリのみ)"
STATUS_CREDENTIAL_REQUIRED = "資格情報が入力されていないため、同期を開始できません。"
...
SETTINGS_GROUP_ACCOUNTS = "メールアカウント"
SETTINGS_BUTTON_ADD_ACCOUNT = "アカウントを追加"
SETTINGS_BUTTON_EDIT_ACCOUNT = "アカウントを編集"
SETTINGS_BUTTON_REFRESH_FOLDERS = "フォルダを再取得"
SETTINGS_BUTTON_SAVE_FOLDERS = "同期対象を保存"
SETTINGS_LABEL_FOLDERS = "同期対象フォルダ"
SETTINGS_STATUS_LOADING = "読み込み中..."
SETTINGS_STATUS_SAVED = "設定を保存しました。"
SETTINGS_STATUS_ACCOUNT_ADDED = "アカウントを追加しました。"
SETTINGS_STATUS_ACCOUNT_UPDATED = "アカウント情報を更新しました。"
SETTINGS_STATUS_FOLDER_SAVED = "同期対象フォルダを保存しました。"
SETTINGS_STATUS_NO_ACCOUNT = "アカウントを選択してください。"
SETTINGS_STATUS_NO_FOLDERS = "フォルダがありません。"
SETTINGS_STATUS_CONNECTION_REQUIRED = "登録前に接続テストを実行してください。"
SETTINGS_STATUS_ACCOUNT_REQUIRED = "アカウント情報を入力してください。"
SETTINGS_STATUS_TESTING_CONNECTION = "接続をテストしています..."
SETTINGS_STATUS_CONNECTION_OK = "接続に成功しました。"
DIALOG_ENTER_PASSWORD_TITLE = "資格情報の再入力"
DIALOG_ENTER_PASSWORD = "アカウント {account_id} のパスワードを入力してください。"
SETTINGS_BUTTON_TEST_CONNECTION = "接続テスト"
SETTINGS_BUTTON_OPEN_LOG_FOLDER = "ログフォルダを開く"
SETTINGS_LABEL_HOST = "ホスト"
SETTINGS_LABEL_PORT = "ポート"
SETTINGS_LABEL_USERNAME = "ユーザー名"
