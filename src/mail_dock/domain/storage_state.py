...
class StorageStateMachine:
    ...
    _TRANSITIONS: ClassVar[dict[tuple[StorageState, StorageEvent], StorageState]] = {
        ...
        (StorageState.RECONNECTING, StorageEvent.PROBE_MISSING): StorageState.RECONNECTING,
        ...
        (StorageState.RECONNECTING, StorageEvent.REPROBE_FAILED): StorageState.DETACHED,
        ...
        (StorageState.VERIFYING, StorageEvent.PROBE_MISSING): StorageState.DETACHED,
